...
void SquareFigure::Draw(PaintCanvas& canvas, const UIInfo& ui_info){
	...
	canvas.Line(left_bottom_.X(), left_bottom_.Y(), left_bottom_.X(), right_top_.Y(), border_thickness_, border_color_);
	canvas.Line(left_bottom_.X(), right_top_.Y(), right_top_.X(), right_top_.Y(), border_thickness_, border_color_);
