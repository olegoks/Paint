...
void PolygonFigure::Draw(PaintCanvas& canvas, const UIInfo& ui_info){
	...
	if (!second_.X() && !second_.Y()) {
		...
		canvas.Line(first_.X(), first_.Y(), second_.X(), second_.Y(), border_color_);
	}
		...
		canvas.Line(second_.X(), second_.Y(), third_.X(), third_.Y(), border_color_);
		canvas.Line(third_.X(), third_.Y(), first_.X(), first_.Y(), border_color_);
